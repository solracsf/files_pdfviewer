...
<html dir="ltr" mozdisallowselectionprint>
  <head data-workersrc="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/pdfjs/build/pdf.worker.mjs')) ?>?v=<?php p($version) ?>"
        ...
        data-iccurl="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/pdfjs/web/iccs/')) ?>"
        data-wasmurl="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/pdfjs/web/wasm/')) ?>">
    <meta charset="utf-8">
    ...
    <script nonce="<?php p($nonce) ?>" src="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/pdfjs/build/pdf.mjs')) ?>?v=<?php p($version) ?>" type="module"></script>
    <script nonce="<?php p($nonce) ?>" src="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/pdfjs/web/viewer.mjs')) ?>?v=<?php p($version) ?>" type="module"></script>
    <script nonce="<?php p($nonce) ?>" src="<?php p($urlGenerator->linkTo('files_pdfviewer', 'js/files_pdfviewer-workersrc.js')) ?>?v=<?php p($version) ?>"></script>
  </head>
            ...
            <div id="toolbarViewer" class="toolbarHorizontalGroup">
              ...
              <div id="toolbarViewerRight" class="toolbarHorizontalGroup">
                ...
                <div class="toolbarHorizontalGroup hiddenMediumView">
                  ...
                  <button id="downloadButton" class="toolbarButton" type="button" disabled="disabled" tabindex="0" data-l10n-id="pdfjs-save-button" hidden="true">
                ...
                <div id="secondaryToolbarToggle" class="toolbarButtonWithContainer">
                  ...
                  <div id="secondaryToolbar" class="hidden doorHangerRight menu">
                    <div id="secondaryToolbarButtonContainer" class="menuContainer">
                      <button id="secondaryOpenFile" class="toolbarButton labeled" type="button" tabindex="0" data-l10n-id="pdfjs-open-file-button" hidden="true">
                      ...
                      <div class="visibleMediumView">
                        ...
                        <button id="secondaryDownload" class="toolbarButton labeled" type="button" disabled="disabled" tabindex="0" data-l10n-id="pdfjs-save-button" hidden="true">
                          <span data-l10n-id="pdfjs-save-button-label"></span>
                        </button>
